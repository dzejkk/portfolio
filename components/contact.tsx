  ...
  return (
    <motion.section
      ...
      <form className="mt-10 flex flex-col">
        <input type="email" className="h-14 rounded-lg border-black px-4" placeholder="email" />
        <textarea className="h-52 border-black p-4 my-3 rounded-lg" placeholder="message" />
        <button
          type="submit"
